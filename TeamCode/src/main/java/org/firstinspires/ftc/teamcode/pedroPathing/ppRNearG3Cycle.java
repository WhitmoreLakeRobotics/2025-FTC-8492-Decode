...
// Set up stuff for pedro path
    ...
    public static Pose pickup1bPose = new Pose(13, 84, Math.toRadians(90)); // (First Set) of Artifacts picked up.
...
public static Pose pickReturn2 =new Pose(20,75,180);
    ...
    public static Pose endPose = new Pose(11,58,Math.toRadians(180));
