...
//import android.graphics.Path;
    ...
    public class PedroAutontest extends OpMode {
        ...
        /* I found these poses wrong for this game so I've redone them to fit what I think it should be for a Goal start position  private final Pose startPose = new Pose(28.5, 128, Math.toRadians(180)); // Start Pose of our robot.
          private final Pose launchPose = new Pose(60, 85, Math.toRadians(135)); // Scoring Pose of our robot. It is facing the goal at a 135 degree angle.
          private final Pose movePose = new Pose(37, 121, Math.toRadians(0)); // Highest (First Set) of Artifacts from the Spike Mark.
    ...
    scorePreload.setConstantInterpolation(startPose.getHeading()); */
           ...
           /* scorePickup1 = follower.pathBuilder()
                    .addPath(new BezierLine(movePose, launchPose))
                    .setLinearHeadingInterpolation(movePose.getHeading(), launchPose.getHeading())
                    .build();
            /*
            ...
            */
            ...
            //      .addPath(new BezierLine( launchPose, startPose))
            //    .setLinearHeadingInterpolation(launchPose.getHeading(),startPose.getHeading())
            //  .build();
        }
        ...
        public void loop() {
            ...
            telemetryMU.update();
            org.firstinspires.ftc.teamcode.pedroPathing.DrawingAuton.drawDebug(follower);
     ...
     /*   telemetryMU.debug("x:" + myOTOS.getPosition().x);
        ...
        public void init() {
            ...
            org.firstinspires.ftc.teamcode.pedroPathing.DrawingAuton.init();
...
//     case 2:
////
//          /* This case checks the robot's position and will wait until the robot position is close (1 inch away) from the movePose's position */
//          if (!follower.isBusy()) {
//              /* Grab Sample */
////
