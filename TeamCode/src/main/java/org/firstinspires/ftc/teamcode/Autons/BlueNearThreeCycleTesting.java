...
@Autonomous(name = "RedNearThreeCycleTesting", group = "Auton")
// @Autonomous(...) is the other common choice

public class BlueNearThreeCycleTesting extends OpMode {
    ...
    public void loop() {
        ...
        switch (currentStage){
            ...
            case _40_LauncherStop:
                if (runtime.milliseconds() >=1500){
                    robot.driveTrain.cmdTurn(360,0.25);
            ...
            case _50_Left1:
                if (robot.driveTrain.getCmdComplete())     {
                    robot.driveTrain.CmdDrive(51,-90,0.35,360);
            ...
            case _70_Backwards1:
                if (robot.driveTrain.getCmdComplete())    {
                    robot.driveTrain.CmdDrive(23,-180,0.35,360);
