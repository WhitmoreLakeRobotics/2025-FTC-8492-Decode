...
public class ppBlueNear4Cycle extends OpMode {
...
// Set up stuff for pedro path
    ...
    public static Pose pickup2aPose = new Pose(48, 54, Math.toRadians(180)); // Middle (Second Set) of Artifacts from the Spike Mark.
