...
import org.firstinspires.ftc.teamcode.Hardware.Robot;
    ...
    @Configurable
    @Autonomous(name = "ppBNear2CyCurve", group = "PP")
// @Autonomous(...) is the other common choice

    public class ppBNear2CyCurve extends OpMode {
...
public static double fastPower = 0.5;
        ...
        private final Pose scorePoseP = new Pose(56, 90, Math.toRadians(135)); // scoring pose after picking up from spikes. It's deliberately short to allow for drift as launching
        ...
        public void buildPaths() {
            ...
            scorePickup1 = follower.pathBuilder()
                    .addPath(new BezierLine(pickup1aPose, scorePoseP))
