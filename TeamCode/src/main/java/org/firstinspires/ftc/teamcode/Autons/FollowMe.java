...
@Autonomous(name = "FollowMe", group = "Auton")
// @Autonomous(...) is the other common choice

public class FollowMe extends OpMode {
    ...
    public void loop() {
        ...
        switch (currentStage){
            ...
            case _00_preStart:
                ...
                break;
            case _10_Drive_Out:
               // robot.trapezoidAutoAim.followMe1();
                if(robot.limey.getTagID() >= 0){
                    robot.driveTrain.CmdDrive(12,robot.driveTrain.getCurrentHeading(),0.70,robot.driveTrain.getCurrentHeading());
                }
                currentStage = stage._10_Drive_Out;
                break;
